...
%solve neighbor
rT_val(2:n,4) = solve_MovingRect(rCtaMap,Spmat,WSize);
figure(3);
...
rlnkappa = solve_MovingRect(lKMap,Spmat,WSize);
...
rT_val(2:n,1) = solve_MovingRect(rTrMapx,Spmat,WSize);          % solve linear equation
rT_val(2:n,2) = solve_MovingRect(rTrMapy,Spmat,WSize);          % solve linear equation
...
%% save the result
save('Optimized_1228_recw','T_val','nT_val','rT_val');