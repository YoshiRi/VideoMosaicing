...
load('../OptimizeData/Optimized_1228_python.mat');
...
save('results\refMap_python','refMap','refMap_c');
...
save('results\MosaicingFull_python', 'buff','Update');
...
%%
save('results\EvalFull_python.mat','evaled')
%% Write to  video
% write to video
v = VideoWriter('results\MappingFull_python.avi');
